...
module.bundle.HMR_BUNDLE_ID = "789f6277e7f3420a";
"use strict";
...
},{}],"iGCK3":[function(require,module,exports,__globalThis) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (modal && modalContent && closeButton) {
        document.querySelectorAll(".modal-link").forEach((link)=>{
            link.addEventListener("click", function(event) {
                ...
                if (url) fetch(url).then((response)=>response.text()).then((data)=>{
    ...
    form.addEventListener("submit", function(event) {
        ...
        fetch("https://formsubmit.co/ajax/info@craftfoodcatering.de", {
            ...
            errorElement.textContent = "Es ist ein Fehler aufgetreten. Bitte versuchen Sie es sp\xe4ter erneut.";
            if (formContainer) formContainer.appendChild(errorElement);
        });
    });
    ...
    inputs.forEach((input)=>{
        input.addEventListener("invalid", function() {
            ...
            if (input.validity.valueMissing) errorMessage.textContent = "Dieses Feld ist erforderlich.";
            else if (input.validity.typeMismatch) errorMessage.textContent = "Bitte geben Sie eine g\xfcltige E-Mail-Adresse ein.";
            else if (input.validity.patternMismatch) errorMessage.textContent = "Bitte halten Sie sich an das geforderte Format.";
            else errorMessage.textContent = "Ung\xfcltige Eingabe.";
        });
    ...
    const gdprErrorMessage = form.querySelector('.gdpr-error-message');
    if (gdprCheckbox && gdprErrorMessage) {
        gdprCheckbox.addEventListener('invalid', ()=>{
            if (!gdprCheckbox.checked) gdprErrorMessage.textContent = "Bitte akzeptieren Sie die Datenschutzerkl\xe4rung";
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@splidejs/splide":"5CJev"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{}],"5CJev":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
